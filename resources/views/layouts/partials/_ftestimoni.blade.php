<div id="features" class="section md-padding bg-primary">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div id="about-slider" class="owl-carousel owl-theme">
                    <img class="img-responsive" src="{{asset('frontend/img/about1.jpg')}}" alt="">
                    <img class="img-responsive" src="{{asset('frontend/img/about2.jpg')}}" alt="">
                    <img class="img-responsive" src="{{asset('frontend/img/about1.jpg')}}" alt="">
                    <img class="img-responsive" src="{{asset('frontend/img/about2.jpg')}}" alt="">
                </div>
            </div>
